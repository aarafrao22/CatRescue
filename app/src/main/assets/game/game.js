...
*	
*	@version 	= 2.0.87
*	@lastupdate = 02/01/2019 15:02:55
*	@year		= 2019
*
*	MCE			= Monkey Creative Engine
*
...
var MonkeyCreative = {
	...
	start : function(){
		MonkeyCreative.debug && console.log('game start');
        //--> monkey extension
	},
	
	mainScene : function(){
        MonkeyCreative.debug && console.log('main menu');
        //--> monkey extension
	},
	
	playClicked : function(){
		MonkeyCreative.debug && console.log('button play ...');
		//--> monkey extension
	},
	
	levelStarted : function( level ){
        MonkeyCreative.debug && console.log('level started:' + level);
		//--> monkey extension
    },
	
	levelUp : function ( level, score ){
        MonkeyCreative.debug && console.log('level finished:' + level+' score:'+score);
		//--> monkey extension
    },
	
	levelReplay : function(level){
		MonkeyCreative.debug && console.log('level replay:' + level);
		//--> monkey extension
	},
	
	levelNext : function(level){
		MonkeyCreative.debug && console.log('level next:' + level);
		//--> monkey extension
	},
	
	levelPause : function(level){
		MonkeyCreative.debug && console.log('level pause:' + level);
		//--> monkey extension
	},

    gameOver : function( level, score ){
        MonkeyCreative.debug && console.log('game over:' + level+' score:'+score);
		//--> monkey extension
    },  
	
	triggerIncentivise : function(callback){
        MonkeyCreative.debug && console.log('triggerIncentivise');
		//--> monkey extension
    },
    ...
    buildKey : function( key ){
        return "monkeycreative.blast."+key;
    },

    getStorageItem: function(key){
        var value;
        try {
            value = localStorage.getItem(MonkeyCreative.buildKey(key));
        }
        catch(error){
            return undefined
        }
    ...
    setStorageItem: function(key, value){
        ...
        try{
            localStorage.setItem(MonkeyCreative.buildKey(key), v);
            return value;
        }
        catch(error){
            return undefined;
...
(function () {
    ...
    W.main = function () {
        ...
        (new d(640, 960+7)).init.connect(W.onInit).once()
        
		//(new d(window.innerWidth, window.innerHeight)).init.connect(W.onInit).once();
    };
    W.onInit = function () {
        W.lang = MonkeyCreative.language;
    ...
    var ha = function () {};
    f["MCE.util.Disposable"] = ha;
    ha.__name__ = ["MCE", "util", "Disposable"];
    ha.prototype = {
        __class__: ha
    };
    var E = function () {};
    f["MCE.Component"] = E;
    E.__name__ = ["MCE", "Component"];
    E.__interfaces__ = [ha];
    E.prototype = {
        onAdded: function () {},
        onRemoved: function () {},
    ...
    var tc = function () {};
    f["MCE.util.PackageLog"] = tc;
    tc.__name__ = ["MCE",
        "util", "PackageLog"
    ];
    var Rb = function () {};
    f["MCE.platform.Platform"] = Rb;
    Rb.__name__ = ["MCE", "platform", "Platform"];
    Rb.prototype = {
        __class__: Rb
    };
    var ta = function () {};
    f["MCE.platform.html.HtmlPlatform"] = ta;
    ta.__name__ = ["MCE", "platform", "html", "HtmlPlatform"];
    ...
    ta.prototype = {
        init: function () {
            ...
            var b = null;
            try {
                b = document.getElementById('content-canvas');
            } catch (c) {}
    ...
    f["MCE.util.SignalConnection"] = Ka;
    Ka.__name__ = ["MCE", "util", "SignalConnection"];
    ...
    f["MCE.util.Signal2"] = Sa;
    Sa.__name__ = ["MCE", "util",
        "Signal2"
    ];
    Sa.__super__ = P;
    ...
    f["MCE.util.Signal1"] = G;
    G.__name__ = ["MCE", "util", "Signal1"];
    G.__super__ =
        P;
    ...
    f["MCE.animation.AnimatedFloat"] = n;
    n.__name__ = ["MCE", "animation", "AnimatedFloat"];
    n.__super__ = S;
    ...
    f["MCE.SpeedAdjuster"] = Tb;
    Tb.__name__ = ["MCE", "SpeedAdjuster"];
    Tb.__super__ = E;
    ...
    var mb = function () {};
    f["MCE.animation.Behavior"] = mb;
    mb.__name__ = ["MCE", "animation", "Behavior"];
    mb.prototype = {
        __class__: mb
    };
    var q = function () {};
    f["MCE.animation.Ease"] = q;
    q.__name__ = ["MCE", "animation", "Ease"];
    q.linear = function (a) {
        return a
    };
    q.quadIn = function (a) {
    ...
    f["MCE.animation.Jitter"] = Ta;
    Ta.__name__ = ["MCE", "animation", "Jitter"];
    ...
    f["MCE.animation.Tween"] = La;
    La.__name__ = ["MCE", "animation", "Tween"];
    ...
    f["MCE.asset.Asset"] =
        za;
    za.__name__ = ["MCE", "asset", "Asset"];
    za.__interfaces__ = [ha];
    za.prototype = {
        __class__: za
    };
    var k = f["MCE.asset.AssetFormat"] = {
        __ename__: ["MCE", "asset", "AssetFormat"],
    ...
    f["MCE.asset.AssetEntry"] = Ub;
    Ub.__name__ = ["MCE", "asset", "AssetEntry"];
    Ub.prototype = {
        __class__: Ub
    };
    var nb = function () {};
    f["MCE.asset.AssetPack"] = nb;
    nb.__name__ = ["MCE", "asset", "AssetPack"];
    ...
    f["MCE.asset.Manifest"] =
        Y;
    Y.__name__ = ["MCE", "asset", "Manifest"];
    ...
    var T = f["MCE.display.BlendMode"] = {
        __ename__: ["MCE", "display", "BlendMode"],
    ...
    T.Copy.toString = s;
    T.Copy.__enum__ = T;
    var ia = f["MCE.display.EmitterType"] = {
        __ename__: ["MCE", "display", "EmitterType"],
    ...
    f["MCE.display.EmitterMold"] = w;
    w.__name__ = ["MCE", "display", "EmitterMold"];
    ...
    f["MCE.display.Sprite"] = r;
    r.__name__ = ["MCE", "display", "Sprite"];
    ...
    f["MCE.display.EmitterSprite"] = J;
    J.__name__ = ["MCE", "display",
        "EmitterSprite"
    ];
    ...
    f["MCE.display._EmitterSprite.Particle"] =
        Wb;
    Wb.__name__ = ["MCE", "display", "_EmitterSprite", "Particle"];
    Wb.prototype = {
        __class__: Wb
    };
    ...
    f["MCE.display.FillSprite"] = qb;
    qb.__name__ = ["MCE", "display", "FillSprite"];
    qb.__super__ = r;
    ...
    f["MCE.display.Glyph"] = rb;
    rb.__name__ = ["MCE", "display", "Glyph"];
    rb.prototype = {
        draw: function (a, b, c) {
    ...
    f["MCE.display.Font"] = Ma;
    Ma.__name__ = ["MCE", "display", "Font"];
    Ma.prototype = {
    ...
    var K = f["MCE.display.TextAlign"] = {
        __ename__: ["MCE", "display", "TextAlign"],
    ...
    f["MCE.display.TextLayout"] = Ba;
    Ba.__name__ = ["MCE", "display", "TextLayout"];
    ...
    f["MCE.display._Font.ConfigParser"] = Na;
    Na.__name__ = ["MCE", "display", "_Font", "ConfigParser"];
    ...
    f["MCE.display._Font.ConfigPair"] = Xb;
    Xb.__name__ = ["MCE", "display", "_Font", "ConfigPair"];
    Xb.prototype = {
        getInt: function () {
    ...
    var Yb = function () {};
    f["MCE.display.Graphics"] = Yb;
    Yb.__name__ = ["MCE", "display", "Graphics"];
    Yb.prototype = {
        __class__: Yb
    };
    var Ua = function (a) {
    ...
    f["MCE.display.ImageSprite"] =
        Ua;
    Ua.__name__ = ["MCE", "display", "ImageSprite"];
    Ua.__super__ = r;
    ...
    var ja = f["MCE.display.Orientation"] = {
        __ename__: ["MCE", "display", "Orientation"],
    ...
    var tb = function () {};
    f["MCE.display.Texture"] = tb;
    tb.__name__ = ["MCE", "display", "Texture"];
    tb.__interfaces__ = [za];
    tb.prototype = {
        __class__: tb
    };
    var xc = function () {};
    f["MCE.display.SubTexture"] = xc;
    xc.__name__ = ["MCE", "display", "SubTexture"];
    ...
    f["MCE.display.TextSprite"] = ub;
    ub.__name__ = ["MCE", "display", "TextSprite"];
    ub.__super__ = r;
    ...
    var R = f["MCE.input.MouseButton"] = {
        __ename__: ["MCE", "input", "MouseButton"],
    ...
    var ca = f["MCE.input.MouseCursor"] = {
        __ename__: ["MCE", "input", "MouseCursor"],
    ...
    f["MCE.input.MouseEvent"] = Zb;
    Zb.__name__ = ["MCE", "input", "MouseEvent"];
    Zb.prototype = {
    ...
    var vb = f["MCE.input.EventSource"] = {
        __ename__: ["MCE", "input", "EventSource"],
    ...
    f["MCE.input.PointerEvent"] = $b;
    $b.__name__ = ["MCE", "input", "PointerEvent"];
    $b.prototype = {
    ...
    f["MCE.input.TouchPoint"] = ac;
    ac.__name__ = ["MCE", "input", "TouchPoint"];
    ac.prototype = {
        init: function (a, b) {
            this.viewX = a;
            this.viewY = b
    ...
    f["MCE.math.Matrix"] = Vb;
    Vb.__name__ = ["MCE", "math", "Matrix"];
    Vb.prototype = {
    ...
    f["MCE.math.Rectangle"] = sb;
    sb.__name__ = ["MCE", "math", "Rectangle"];
    sb.prototype = {
    ...
    f["MCE.platform.BasicAsset"] = U;
    U.__name__ = ["MCE", "platform", "BasicAsset"];
    U.__interfaces__ = [za];
    U.prototype = {
        dispose: function () {
            this._disposed ||
    ...
    f["MCE.platform.BasicAssetPackLoader"] = Ca;
    Ca.__name__ = ["MCE", "platform", "BasicAssetPackLoader"];
    ...
    f["MCE.platform._BasicAssetPackLoader.BasicAssetPack"] = xb;
    xb.__name__ = ["MCE", "platform", "_BasicAssetPackLoader", "BasicAssetPack"];
    ...
    f["MCE.platform.BasicFile"] = Va;
    Va.__name__ = ["MCE", "platform", "BasicFile"];
    ...
    var Ac = function () {};
    f["MCE.subsystem.MouseSystem"] = Ac;
    Ac.__name__ = ["MCE", "subsystem", "MouseSystem"];
    var Z = function (a) {
        this._pointer = a;
    ...
    f["MCE.platform.BasicMouse"] = Z;
    Z.__name__ = ["MCE", "platform", "BasicMouse"];
    Z.__interfaces__ = [Ac];
    Z.prototype = {
    ...
    var cc = function () {};
    f["MCE.subsystem.PointerSystem"] =
        cc;
    cc.__name__ = ["MCE", "subsystem", "PointerSystem"];
    cc.prototype = {
        __class__: cc
    };
    ...
    f["MCE.platform.BasicPointer"] = Q;
    Q.__name__ = ["MCE", "platform", "BasicPointer"];
    Q.__interfaces__ = [cc];
    Q.prototype = {
        get_x: function () {
            return this._x
    ...
    f["MCE.platform.BasicTexture"] = Da;
    Da.__name__ = ["MCE", "platform", "BasicTexture"];
    ...
    var yc = function () {};
    f["MCE.subsystem.TouchSystem"] =
        yc;
    yc.__name__ = ["MCE", "subsystem", "TouchSystem"];
    var hb = function (a, b) {
        null == b && (b = 4);
        this._pointer = a;
        this._maxPoints = b;
    ...
    f["MCE.platform.BasicTouch"] = hb;
    hb.__name__ = ["MCE", "platform", "BasicTouch"];
    ...
    f["MCE.platform.DummySound"] = aa;
    aa.__name__ = ["MCE", "platform", "DummySound"];
    ...
    var Pa = function () {};
    f["MCE.sound.Playback"] = Pa;
    Pa.__name__ = ["MCE", "sound", "Playback"];
    ...
    f["MCE.platform.DummyPlayback"] = yb;
    yb.__name__ = ["MCE", "platform", "DummyPlayback"];
    ...
    var zb = function () {};
    f["MCE.subsystem.StorageSystem"] = zb;
    zb.__name__ = ["MCE", "subsystem", "StorageSystem"];
    zb.prototype = {
        __class__: zb
    };
    var kb = function () {
    ...
    f["MCE.platform.DummyStorage"] = kb;
    kb.__name__ = ["MCE", "platform", "DummyStorage"];
    ...
    f["MCE.platform.DummyTouch"] = ib;
    ib.__name__ = ["MCE", "platform", "DummyTouch"];
    ...
    f["MCE.platform.EventGroup"] = Wa;
    Wa.__name__ = ["MCE", "platform", "EventGroup"];
    ...
    f["MCE.platform._EventGroup.Entry"] = dc;
    dc.__name__ = ["MCE", "platform", "_EventGroup", "Entry"];
    dc.prototype = {
        __class__: dc
    };
    var Ab = function () {};
    f["MCE.platform.InternalGraphics"] = Ab;
    Ab.__name__ = ["MCE", "platform", "InternalGraphics"];
    ...
    var ec =
        function () {};
    f["MCE.subsystem.RendererSystem"] = ec;
    ec.__name__ = ["MCE", "subsystem", "RendererSystem"];
    ec.prototype = {
        __class__: ec
    };
    var Bb = function () {};
    f["MCE.platform.InternalRenderer"] = Bb;
    Bb.__name__ = ["MCE", "platform", "InternalRenderer"];
    ...
    f["MCE.platform.MainLoop"] = Ia;
    Ia.__name__ = ["MCE", "platform", "MainLoop"];
    ...
    var bc = function () {};
    f["MCE.platform.MouseCodes"] = bc;
    bc.__name__ = ["MCE", "platform", "MouseCodes"];
    ...
    var fc = function () {};
    f["MCE.platform.TextureRoot"] = fc;
    fc.__name__ = ["MCE", "platform", "TextureRoot"];
    fc.prototype = {
        __class__: fc
    };
    var Cb = function () {};
    f["MCE.platform.Tickable"] = Cb;
    Cb.__name__ = ["MCE", "platform", "Tickable"];
    Cb.prototype = {
        __class__: Cb
    };
    var Db =
    ...
    f["MCE.platform.html.CanvasGraphics"] = Db;
    Db.__name__ = ["MCE", "platform", "html", "CanvasGraphics"];
    ...
    f["MCE.platform.html.CanvasRenderer"] = Ja;
    Ja.__name__ = ["MCE", "platform", "html", "CanvasRenderer"];
    ...
    f["MCE.platform.html.CanvasTexture"] = Eb;
    Eb.__name__ = ["MCE", "platform", "html", "CanvasTexture"];
    Eb.__super__ = Da;
    ...
    f["MCE.platform.html.CanvasTextureRoot"] = Xa;
    Xa.__name__ = ["MCE", "platform", "html", "CanvasTextureRoot"];
    ...
    f["MCE.platform.html.HtmlAssetPackLoader"] = B;
    B.__name__ = ["MCE",
    ...
    f["MCE.platform.html.HtmlMouse"] = gb;
    gb.__name__ = ["MCE", "platform", "html", "HtmlMouse"];
    gb.__super__ = Z;
    ...
    f["MCE.platform.html.HtmlSound"] = Ya;
    Ya.__name__ = ["MCE", "platform", "html", "HtmlSound"];
    ...
    f["MCE.platform.html._HtmlSound.HtmlPlayback"] = Za;
    Za.__name__ = ["MCE", "platform", "html", "_HtmlSound", "HtmlPlayback"];
    ...
    var gc = function () {};
    f["MCE.subsystem.StageSystem"] = gc;
    gc.__name__ = ["MCE", "subsystem", "StageSystem"];
    gc.prototype = {
        __class__: gc
    };
    var Ha = function (a) {
    ...
    f["MCE.platform.html.HtmlStage"] = Ha;
    Ha.__name__ = ["MCE", "platform", "html", "HtmlStage"];
    ...
    Ha.prototype = {
        ...
        requestFullscreen: function (a) {
            ...
            if (a) {
				...
				null != b && b.length != 0 && b.apply(a, [])
            } else{ 
				a = u.loadFirstExtension(["cancelFullscreen", "cancelFullScreen"],				
				window.document).value, null != a && a.length!=0 && F.callMethod(window.document, a, []);
			}
        },
    ...
    f["MCE.platform.html.HtmlStorage"] = jb;
    jb.__name__ = ["MCE", "platform", "html", "HtmlStorage"];
    ...
    var u = function () {};
    f["MCE.platform.html.HtmlUtil"] = u;
    u.__name__ = ["MCE", "platform", "html", "HtmlUtil"];
    ...
    var hc = function () {};
    f["MCE.subsystem.WebSystem"] = hc;
    hc.__name__ = ["MCE", "subsystem", "WebSystem"];
    hc.prototype = {
        __class__: hc
    };
    var lb = function (a) {
    ...
    f["MCE.platform.html.HtmlWeb"] = lb;
    lb.__name__ = ["MCE", "platform", "html", "HtmlWeb"];
    ...
    f["MCE.platform.html.WebAudioSound"] = A;
    A.__name__ = ["MCE", "platform", "html", "WebAudioSound"];
    A.__interfaces__ = [Oa];
    A.__properties__ = {
    ...
    f["MCE.platform.html._WebAudioSound.WebAudioPlayback"] = $a;
    $a.__name__ = ["MCE", "platform", "html", "_WebAudioSound",
        "WebAudioPlayback"
    ];
    ...
    f["MCE.scene.Director"] = Fb;
    Fb.__name__ = ["MCE", "scene", "Director"];
    Fb.__super__ = E;
    Fb.prototype = z(E.prototype, {
        ...
        unwindToScene: function (a, b) {
            ...
            if (null != e) {
                if (e != a) {
                    for (this.scenes.pop(); 0 < this.scenes.length && this.scenes[this.scenes.length - 1] != a;) 
    ...
    f["MCE.scene._Director.Transitor"] = ic;
    ic.__name__ = ["MCE", "scene",
        "_Director", "Transitor"
    ];
    ic.prototype = {
        init: function (a) {
    ...
    var ab = function () {};
    f["MCE.scene.Transition"] = ab;
    ab.__name__ = ["MCE", "scene", "Transition"];
    ab.prototype = {
        init: function (a, b, c) {
            this._director = a;
            this._from = b;
    ...
    f["MCE.scene.TweenTransition"] = ua;
    ua.__name__ = ["MCE", "scene", "TweenTransition"];
    ua.__super__ = ab;
    ...
    var qa = function () {};
    f["MCE.script.Action"] = qa;
    qa.__name__ = ["MCE", "script", "Action"];
    qa.prototype = {
        __class__: qa
    };
    ...
    f["MCE.script.AnimateTo"] = Gb;
    Gb.__name__ = ["MCE", "script", "AnimateTo"];
    ...
    f["MCE.script.CallFunction"] = ga;
    ga.__name__ = ["MCE", "script", "CallFunction"];
    ...
    f["MCE.script.Delay"] = na;
    na.__name__ = ["MCE", "script", "Delay"];
    ...
    f["MCE.script.Parallel"] = Hb;
    Hb.__name__ = ["MCE", "script", "Parallel"];
    ...
    f["MCE.script.Repeat"] = Ib;
    Ib.__name__ = ["MCE", "script", "Repeat"];
    ...
    f["MCE.script.Script"] = ma;
    ma.__name__ = ["MCE", "script", "Script"];
    ma.__super__ = E;
    ...
    f["MCE.script._Script.Handle"] = Jb;
    Jb.__name__ = ["MCE", "script", "_Script", "Handle"];
    ...
    f["MCE.script.Sequence"] = xa;
    xa.__name__ = ["MCE", "script", "Sequence"];
    ...
    f["MCE.script.Shake"] = ya;
    ya.__name__ = ["MCE", "script", "Shake"];
    ...
    var da = f["MCE.subsystem.RendererType"] = {
        __ename__: ["MCE", "subsystem", "RendererType"],
    ...
    f["MCE.swf.Flipbook"] = kc;
    kc.__name__ = ["MCE", "swf", "Flipbook"];
    kc.prototype = {
    ...
    f["MCE.swf.FlipbookFrame"] = jc;
    jc.__name__ = ["MCE", "swf", "FlipbookFrame"];
    jc.prototype = {
        toSymbol: function () {
            return new Lb(this)
        },
    ...
    f["MCE.swf._Flipbook.FrameSymbol"] = Lb;
    Lb.__name__ = ["MCE", "swf", "_Flipbook", "FrameSymbol"];
    ...
    var bb = function () {};
    f["MCE.swf.Library"] = bb;
    bb.__name__ = ["MCE", "swf", "Library"];
    ...
    f["MCE.swf.MovieSprite"] = cb;
    cb.__name__ = ["MCE", "swf", "MovieSprite"];
    cb.__super__ = r;
    ...
    f["MCE.swf._MovieSprite.LayerAnimator"] = lc;
    lc.__name__ = ["MCE", "swf", "_MovieSprite", "LayerAnimator"];
    lc.prototype = {
    ...
    f["MCE.swf.MovieSymbol"] = Mb;
    Mb.__name__ = ["MCE", "swf", "MovieSymbol"];
    ...
    f["MCE.swf.MovieLayer"] = mc;
    mc.__name__ = ["MCE", "swf", "MovieLayer"];
    mc.prototype = {
        __class__: mc
    };
    var nc = function (a, b) {
    ...
    f["MCE.swf.MovieKeyframe"] = nc;
    nc.__name__ = ["MCE", "swf", "MovieKeyframe"];
    nc.prototype = {
    ...
    var wc =
        function () {};
    f["MCE.util.Assert"] = wc;
    wc.__name__ = ["MCE", "util", "Assert"];
    wc.that = function () {};
    var pb = function () {};
    f["MCE.util.BitSets"] = pb;
    pb.__name__ = ["MCE", "util", "BitSets"];
    ...
    f["MCE.util.Config"] = db;
    db.__name__ = ["MCE", "util", "Config"];
    db.parse = function (a) {
    ...
    f["MCE.util.MessageBundle"] = eb;
    eb.__name__ = ["MCE", "util", "MessageBundle"];
    eb.parse = function (a) {
    ...
    f["MCE.util.Promise"] = wb;
    wb.__name__ = ["MCE", "util", "Promise"];
    wb.prototype = {
    ...
    f["MCE.util.Signal0"] = oa;
    oa.__name__ = ["MCE", "util", "Signal0"];
    oa.__super__ = P;
    ...
    f["MCE.util._SignalBase.Task"] = Sb;
    Sb.__name__ = ["MCE", "util", "_SignalBase", "Task"];
    Sb.prototype = {
        __class__: Sb
    };
    var M = function () {};
    f["MCE.util.Strings"] = M;
    M.__name__ = ["MCE", "util", "Strings"];
    ...
    var X = function () {
        ...
        d.addButton(this.root, 550, 60, "pause_btn", function () {
			MonkeyCreative.levelPause(X.cLevel + 1);
    ...
    Ob.prototype = z(E.prototype, {
        ...
        showHUD: function () {
            ...
            d.addImageSprite(this.hudLayer, 0,-22, "hud_top_bg", 1, 1, !1);
            d.addImageSprite(this.hudLayer, 0, 820, "hud_bottom_bg", 1, 1, !1);
        ...
        makeLevelEnd: function (a) {
            ...
            }, !1) : (a ? (t.muteSoundtrack(), t.playSfx("game_over_sfx", 0.5), MonkeyCreative.gameOver(this.cLevel, this.cLevelScore)) : t.playSfx("level_end_sfx"), a || (fa.unlockedLevels < this.cLevel + 1 && (fa.unlockedLevels = this.cLevel + 1, fa.saveData()),
                MonkeyCreative.levelUp(this.cLevel + 1, this.cLevelScore)), d.addDelay(this.owner, 1, function () {
                d.pushScene((new qc(b.cLevelScore, a,b.cLevel + 1)).root)
            }, !1));
            if(!a) MonkeyCreative.dp_submitScore(this.cLevelScore,this.cLevel + 1);
        },
        updateScore: function (a) {
            this.cLevelScore += a;
    ...
    var qc = function (a, b,c) {
        ...
        if (b) {
            ...
            c.centerAnchor();
            c.setAlign(K.Center);
			setTimeout(MonkeyCreative.dp_share,2000);
        } else d.addImageSprite(this.root, d.halfWidth, 250, "level_end_flag"), d.addLabel(this.root, d.halfWidth, d.halfHeight + 120, "" + a, 1.2, 1, !0, "score_font"),d.addLabel(this.root, d.halfWidth, d.halfHeight + 170, ""+c, 1.2, 1, !0, "score_font"), d.addImageSprite(this.root, d.halfWidth, d.halfHeight - 15, "score_icon"), d.addButton(this.root,
            d.halfWidth + 150, d.halfHeight + 280, "play_small_btn", function () {
                X.cLevel += 1;
				MonkeyCreative.levelNext(X.cLevel + 1);
        ...
        d.addButton(this.root, d.halfWidth + c, d.halfHeight + 280, "replay_btn", function () {
            t.unmuteSoundtrack();
			MonkeyCreative.levelReplay(X.cLevel + 1);
            d.goToScene((new X).root);
        })
        ...
        initLevelSelectButton: function (a, b, c) {
            var e =
                ...
                a = d.addButton(this.levelSelectLayer, a, b, "btn_level_select", function () {
                    X.cLevel = e;
					MonkeyCreative.levelStarted(e + 1);
                    d.goToScene((new X).root);
                });
            e <= fa.unlockedLevels ? d.addLabel(a, 58, 50, c, 1, 1, !0, "score_font") : (a._compMap.Sprite_0.disablePointer(), d.addImageSprite(a, 61, 60, "lock_icon"))
        },
        __class__: rc
    };
    ...
    var wa = function () {
        ...
        var a;
		//aa= d.addImageSprite(this.root, 0,  480, "game_scene_bg", 1, 1, !1)._compMap.Sprite_0;
		a = d.addImageSprite(this.root, 0, 0, "game_scene_bg", 1, 1, !1)._compMap.Sprite_0;
        ...
        this.gameTitleSprite = d.addImageSprite(this.root,
            d.halfWidth -8, d.halfHeight - 70, "game_title", 1, 1)._compMap.Sprite_0;
        ...
        g = d.addButton(this.root, d.halfWidth - 220, d.height - 140, "more_games_btn", function () {
            MonkeyCreative.clickMore();
        }, "", 1, 0)._compMap.Sprite_0;
        g.alpha.animateTo(1, 1, q.quadOut);
        g.y.animateTo(d.height - 190, 1, q.bounceOut)
        MonkeyCreative.mainScene();
    };
    ...
    d.prototype = {
        onResize: function () {
			...
			if(a<480){
				d.director._compMap.Sprite_0.setXY(0, 0);
				d.director._compMap.Sprite_0.setScaleXY(a / d.width, b / d.height);
			}
			else{
				//console.log(d.scale, a, b, d.width, d.height, 0.5 * a - 0.5 * d.scale * d.width, 0.5 * b - 0.5 * d.scale * d.height);
